...
* [Volatility Indicator Functions](#volatility-indicator-functions)
* []


# 1 Overlap Studies Functions 重叠研究指标 <span id="overlap-studies-functions"></span>
...
### 1.2DEMA - Double Exponential Moving Average  双移动平均线
...
# Momentum Indicator Functions 动量指标函数 <span id="momentum-indicator-functions"></span>
...
# Volume Indicators 成交量指标<span id="volume-indicators"></span>
...
# Volatility Indicator Functions 波动率指标函数  <span id="volatility-indicator-functions"></span>
